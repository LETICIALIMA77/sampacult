...
<!DOCTYPE html>
<html lang="en">
<link rel="shortcut icon" href="./img/cult.jpeg" type="image/x-icon">
<head>
    <meta charset="UTF-8">
...
<form>
  ...
  <div class="btns">
<button class='btns_more' onclick="enviar()" href="./index.php">Entrar</button>
</div>
</form>
</div>
</div>
 ...
 <div class="img-inner">
 <img src='./img/cult.jpeg'  alt="" class="container_img"/>
       </div>
     </div>
  </div>
...
<script>
  function enviar(){
    ...
    //     window.location.replace('localhost/sampacult/index.php?');
    //   }
    // });
  }
</script>
